# Generated by Django 4.2 on 2023-07-26 10:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='app.document')),
                ('nomenclature', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.nomenclature')),
            ],
        ),
        migrations.AddField(
            model_name='document',
            name='transport',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='app.vehicles'),
        ),
    ]
